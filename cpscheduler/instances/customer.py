...
def customer_scheduling_instance(
    ...
    *,
    ...
    base_instance = pd.concat(
        [instance.assign(instance_id=i) for i, instance in enumerate(base_instances, 1)],
        ignore_index=True,
    )
    ...
    weights_distribution = base_instance[weight_feature].value_counts().sort_index().to_numpy()
