...
def test_is_tasks_compiled() -> None:
    ...
    assert tasks.__file__.endswith(".so") or tasks.__file__.endswith(".pyd")
...
def test_is_instructions_compiled() -> None:
    ...
    assert instructions.__file__.endswith(".so") or instructions.__file__.endswith(".pyd")
...
def test_is_schedule_setup_compiled() -> None:
    ...
    assert schedule_setup.__file__.endswith(".so") or schedule_setup.__file__.endswith(".pyd")
...
def test_is_objectives_compiled() -> None:
    ...
    assert objectives.__file__.endswith(".so") or objectives.__file__.endswith(".pyd")
...
def test_is_constraints_compiled() -> None:
    ...
    assert constraints.__file__.endswith(".so") or constraints.__file__.endswith(".pyd")
